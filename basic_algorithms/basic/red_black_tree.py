...
# Now let's cause some rotations. When we insert 16, it goes under 13,
# but 13 does not have a red sibling. 16 rotates into 13's spot,
# because it's currently an _inside_ sub-tree. Then 16 rotates into 19's spot.
# After these rotations, the ordering of the BST has been preserved _and_ our tree is balanced.
tree.insert(16)
print_tree(tree.root)
