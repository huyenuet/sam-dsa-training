...
def get_most_common_month(people):
    ...
    max_birthday_count = 0
    for key in months:
        if months[key] > max_birthday_count:
            max_birthday_count = months[key]
...
# Actual result (because of april_birthdays.update())
# {'Robert': 89, 'Joseph': 25, 'Margaret': 35, 'Lawrence': 87, 'Dusty': 53, 'Lisa': 37, 'Carol': 36, 'Michael': 11, 'Andrew': 13, 'Erica': 72}
# August
